    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <Image src="/logo.png" alt="felix" width={20} height={20}
            style={{ borderRadius: '3px', imageRendering: 'pixelated', filter: 'drop-shadow(0 0 4px rgba(232,108,44,0.5))' }}
          />
          <span style={{ fontFamily: 'var(--pixel-font)', fontSize: '7px', color: 'var(--text-dim)', letterSpacing: '0.5px' }}>
            FELIXFORLEARNAI · MIT LICENSE
          </span>
        </div>
        ...
        <div style={{ display: 'flex', gap: '18px', alignItems: 'center' }}>
          {[
            ...
            <Link key={l.href} href={l.href} style={{
              ...
              color: 'var(--text-dim)', textDecoration: 'none', letterSpacing: '0.5px',
          ...
          <a href="https://x.com/felixforlearnai" target="_blank" rel="noopener noreferrer"
            title="Follow on X"
            style={{ color: 'var(--text-dim)', display: 'flex', alignItems: 'center', transition: 'color 0.15s, filter 0.15s' }}
            ...
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'var(--text-dim)'; (e.currentTarget as HTMLElement).style.filter = 'none'; }}
          >
            <XIcon />
          </a>
